            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form method="post" class="pt-3">
                  ...
                  <div class="form-group">
                    <input type="text" name="email_or_phone" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email or Phone">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Already have an account? <a href="{{ route('doctor.loginPage') }}" style="vertical-align: baseline" class="btn btn-link p-0">Login</a>
                  </div>
                </form>
              </div>
            </div>
