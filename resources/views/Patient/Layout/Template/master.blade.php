...
<head>
    ...
    @include('Patient.Layout.Template.share.header-css')
</head>

<body>
    @include('Patient.Layout.Template.share.topbar')

    @include('Patient.Layout.Template.share.nav')
    ...
    <!-- Blog End --> --}}
    @include('Patient.Layout.Template.share.footer')
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>

    @include('Patient.Layout.Template.share.footer-script')
</body>
