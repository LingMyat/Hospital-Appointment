                    ...
                    <div class="card">
                                    ...
                                    <div class="" style="height: 60vh; overflow-y: scroll; overflow-x:hidden;"
                                        ...
                                        <div id="message_Container">
                                            @foreach ($messages as $message)
                                                @if ($message->user->id == patientAuth()->id)
                        ...
                        <div class="card-footer">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary" data-url="{{-- route('liveChat#storeMessage') --}}" id="send-btn">send <i class="fa-solid fa-paper-plane"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            socket.on('message', (data) => {
                ...
                <div class="mb-2 px-2 d-flex gap-2">
                        ...
                        <small class="row msg-content">
                            ...
                            <b style="background: rgba(62, 75, 91, 0.2);color: #3e4b5b;" class="col-lg-5 col-11 col-md-7 col-sm-9 bg-secondary-light ms-2 mt-1 py-2 rounded-1">
                                <i>
                                    <small>${data.message}</small>
                                </i>
                            </b>
